  ...
  const handleSubmit = async () => {
    try {
      ...
      const res = await fetch(
        "https://brs-backend-z4da.onrender.com/api/auth/login",
        {
          method: "POST",
          headers: {
      ...
      if (res.status === 200) {
        ...
        localStorage.setItem(
          "userInfo",
          JSON.stringify({ user: data.user, token: data.token, type: "email" })
        );
        navigate("/");
      } else {
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
      <div className="max-w-screen-xl m-0 sm:m-20 bg-white shadow sm:rounded-lg flex justify-center flex-1">
            ...
            <div className="w-full flex-1 mt-8">
              ...
              <div className="mx-auto max-w-xs">
                ...
                <button
                  ...
                  className="mt-5 tracking-wide font-semibold bg-[#0c1220] text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
                >
                  <svg
        ...
        <div className="flex-1 bg-indigo-100 text-center hidden lg:flex px-20 py-20">
          <Lottie
            options={{
              autoplay: true,
              loop: true,
